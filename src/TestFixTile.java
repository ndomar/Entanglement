...
public class TestFixTile
{
    ...
    {
        final String boardTemplate = "4\n1\n1\n%s\n1\n5\n4\n1";
        
        BoardInterface verticalStraightTiled = new Board(new StringReader(String
                .format(boardTemplate, "2 3 0 1")));
        TestUtil.playSequence(verticalStraightTiled, "ffff");
        assertTrue("Height of the board is not configure correctly.", 
                verticalStraightTiled.isGameOver(0));
        
        BoardInterface verticalCurveTiled = new Board(new StringReader(String
                .format(boardTemplate, "1 0 3 2")));
        TestUtil.playSequence(verticalCurveTiled, "f");
        assertTrue("Width of the board is not configure correctly.", 
                verticalCurveTiled.isGameOver(0));
    }
}
